...
export const plansRouter = router({
  ...
  // recentBlocks (module 10's interim blocked-flash source) was retired in
  // module 11 — the C3 amber flash now consumes activity.feed's blocked
  // stream (hooks/use-blocked-flash.ts), as module 10's HANDOFF directed.
