...
const webTestEnv = {
  ...
  // doc 14: estate escrow (web encrypts at enroll) + claim delegates.
  ...
  CLAIM_DELEGATE_ADDRESS_ARBITRUM: "0x92427d60cda5f63740d95Ad972dFA5A115AdD8d0",
  ...
  ESCROW_DEV_SECRET: "test-escrow-secret",
};
